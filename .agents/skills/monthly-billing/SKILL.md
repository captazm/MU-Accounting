...
description: How to perform Monthly Billing and Invoice Generation
---
...
- In Draft mode, you can modify any additional fees for the selected client's crew, including:
  ...
  - **Gear**: Working Gear Fees
- The total amount will be updated automatically.

## 4. Send Invoice to Client
- Once details are confirmed, click **Send**.
- The bill's status will update to **SENT**.
- Note: After it is sent, the extra fees become read-only and can no longer be modified. Ensure everything is correct before sending.
